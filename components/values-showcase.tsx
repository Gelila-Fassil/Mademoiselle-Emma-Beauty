...
const values = [
  { icon: Leaf, title: "Sustainability", image: "/makeup/pic12.jpg" },
  { icon: Sparkles, title: "Innovation", image: "/makeup/pic4.jpg" },
  { icon: Heart, title: "Quality", image: "/makeup/pic5.jpg" },
  { icon: Shield, title: "Integrity", image: "/makeup/pic6.jpg" },
  { icon: Globe, title: "Global Impact", image: "/makeup/pic7.jpg" },
  { icon: Award, title: "Excellence", image: "/makeup/pic8.jpg" },
];
  ...
  return (
    ...
    >
      <div className="w-[85%] mx-auto">
        ...
        <div className="mb-12">
          <div
            className={`relative h-[500px] rounded-3xl overflow-hidden border border-[#BBA14F]/20 transition-all duration-1000 ${
          ...
          {values.map((value, index) => {
            ...
            return (
              ...
              >
                ...
                />
                <div
                  className={`absolute inset-0 bg-[#BBA14F]/20 ${
                    activeIndex === index
                      ? "opacity-60"
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div
                    className={`p-3 bg-black/40 backdrop-blur-sm rounded-xl border border-[#BBA14F]/30 transition-transform ${
