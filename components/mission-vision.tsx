  ...
  return (
    ...
    >
      <div className="w-[85%] mx-auto">
            ...
            <div className="md:col-span-2 relative h-[400px] rounded-2xl overflow-hidden border border-[#BBA14F]/20">
              ...
              <div className="absolute inset-0 flex items-center p-8">
                <p className="text-lg text-white/90 leading-relaxed max-w-xl">
                  To create products that enhance natural beauty while
                  respecting our planet. We combine scientific innovation with
                  sustainable practices to deliver luxury cosmetics that make a
                  difference.
                </p>
              </div>
            </div>
        ...
        <div
          className={`grid md:grid-cols-3 gap-8 items-center transition-all duration-1000 delay-200 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          <div className="md:col-span-2 md:order-2 relative h-[400px] rounded-2xl overflow-hidden border border-[#BBA14F]/20">
            <Image
              src="/makeup/pic10.jpg"
              alt="Vision"
              fill
              className="object-cover"
            />
            ...
            <div className="absolute inset-0 flex items-center justify-end p-8">
              <p className="text-lg text-white/90 leading-relaxed max-w-xl text-right">
                To become the global leader in sustainable luxury beauty, where
                every product tells a story of innovation, elegance, and
