        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center min-h-[80vh]">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              ...
              <p className="text-xl text-white/70 leading-relaxed max-w-xl">
                A decade of redefining luxury cosmetics through innovation,
                sustainability, and uncompromising quality. Every product tells
                a story of elegance.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative h-[600px] md:h-[700px]">
            <div className="absolute inset-0 space-y-4">
              ...
              <div
                className={`relative h-[45%] rounded-2xl overflow-hidden border border-[#BBA14F]/20 transition-all duration-1000 delay-500 ${
                  isVisible
                    ? "opacity-100 translate-x-0"
                    : "opacity-0 translate-x-10"
                }`}
              ...
              <div
                className={`relative h-[45%] rounded-2xl overflow-hidden border border-[#BBA14F]/20 ml-auto w-[85%] transition-all duration-1000 delay-700 ${
                  isVisible
                    ? "opacity-100 translate-x-0"
                    : "opacity-0 translate-x-10"
                }`}
